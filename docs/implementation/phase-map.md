...
- **Phase 1.56 partial**: `@lfp2p/content-addressing` package is implemented and tested. Schema integration, CID wrappers, storage adapters, and golden fixture set remain.
